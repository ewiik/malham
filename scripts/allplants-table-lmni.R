...
abbnames$SpeciesAbb <- c("A-linn","Ca-cf-ham","Ca-stag",'Ch-asp',"Ch-cont","Ch-glob",
...
dlong$LMNI[dlong$SpeciesAbb %in% c("Ch-vul",'Ch-cont','Ch-asp','Ch-vir', 'Ch-glob') & dlong$Date %in% c(1993, 1994, 1995)] <- NA
...
sptable <- 
  ...
  scale_fill_viridis(guide = guide_colorbar(barwidth=20))  

ggsave("../figs/species-lmni.jpg",sptable, width=17, height=10, units = "cm")
